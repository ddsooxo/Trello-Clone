...
//------------------USER ROUTES-------------------------------
//submit user login
app.post('/api/login', UsersController.submitLogin);
// //create new user account 
// app.get('/api/user/register', UsersController.register)
// app.post('/api/user/register', UsersController.submitRegister);
